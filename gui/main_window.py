...
class LoaderGUI(QWidget):
    ...
    def _create_run_mode_group(self):
        ...
        self.target_input.setText(r"C:/Windows/System32/werfault.exe")          self.target_input.hide()          self.pid_input = QLineEdit()
        self.pid_input.setPlaceholderText("输入目标进程ID (如: 1234)")
        self.pid_input.setText("0")          self.pid_input.hide()          run_layout.addWidget(self.run_mode_box)
